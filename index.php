    ...
    <div class="content_wrapper clearfix">
        ...
        <div class="sections_group">
            ...
            <div class="entry-content">
                ...
                <div  class="section" style="padding-top:50px; padding-bottom:10px; background-image:url(content/images/home_school_section_book.jpg); background-repeat:repeat; background-position:center top; ">
                    <div class="section_wrapper clearfix">
                        <div class="items_group clearfix">
                            <!-- Page Title-->
                            <!-- One full width row-->
                ...
                <div class="section" style="padding-top:65px; padding-bottom:0px; background-color:#fff; background-image:url(content/images/teacher_section_book_bottom.png); background-repeat:no-repeat; background-position:center top; ">
                    <div class="section_wrapper clearfix">
                        <div class="items_group clearfix">
                            <!-- One full width row-->
                            ...
                            <div class="column one-third column_icon_box ">
                                ...
                                <div class="animate" data-anim-type="fadeInRightLarge">
                                    <div class="icon_box icon_position_left no_border">
                                        ...
                                        <div id="contact_me" class="desc_wrapper">
                                            <h4>Recreation</h4>
                                            <div class="desc">
                                                Vitae adipiscing turpis. Aenean ligula nibh in, molestie id viverra a, dapibus at dolor.
                                            </div>
                ...
                <div class="section" style="padding-top:0px; padding-bottom:0px; background-color:#fff; background-image:url(content/images/teacher_section_register.jpg); background-repeat:no-repeat; background-position:center top; ">
                    <div class="section_wrapper clearfix">
                        <div class="items_group clearfix">
                            <!-- One Second (1/2) Column -->
                            <div class="column one-second column_image ">
                                <div class="image_frame no_link scale-with-grid aligncenter no_border">
                                    <div class="image_wrapper"><img class="scale-with-grid" src="content/images/home_school_children.png" alt="">
                                    </div>
                                </div>
                            </div>
                            <!-- One Second (1/2) Column -->
