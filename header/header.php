...
<head>
    ...
    <!-- Favicons -->
    <link rel="shortcut icon" href="content/school/images/favicon.ico">
    ...
    <link rel='stylesheet' href='http://fonts.googleapis.com/css?family=Cormorant+Garamond:100,300,400,400italic,500,700,700italic'>
    <link rel='stylesheet' href='http://fonts.googleapis.com/css?family=Courgette:100,300,400,400italic,500,700,900'>

    <!-- CSS -->
    <link rel='stylesheet' href='cssHeader/global.css'>
...
<div id="Wrapper">
   <!-- Actual header with centered logo-->
                            ...
                            <div class="menu_wrapper" style="height: 25px;">
                                ...
                                <nav id="menu" style="padding-top: 25px;">
                                    <ul style="text-align: right;" id="menu-main-menu-left" class="menu menu_left">
                                        ...
                                        <li>
                                            <a href="index.php#about_me"><span>About me</span></a>
                                        </li>
                                    </ul>
                                    <ul style="text-align: left;" id="menu-main-menu-right" class="menu menu_right">
                                        <li>
                                            <a href="index.php#contact_me"><span>Contact me</span></a>
                                        </li>
                                        <li>
    ...
    <script src="jsHeader/jquery-2.1.4.min.js"></script>
    <script src="jsHeader/mfn.menu.js"></script>
    <script src="jsHeader/scripts.js"></script>
    <!-- JS FOR RESPONSIVE MENU-->
</body>
</html>
